...
enyo.kind({
    ...
    components: [
        ...
        kind: "canvas.Control",
        components: [
            {name: "poly1", kind: "shape2D.PolyCurve", xPoints:[100,200,250,270,340,350,400,500,600,700,750,775,780,800], yPoints:[250,350,300,350,200,100,200,300,200,100,200,180,190,195]}
