...
enyo.kind({
    ...
    components: [
        ...
        kind: "canvas.Control",
        components: [
            {name: "poly1", kind: "shape2D.PolyLine", xPoints:[100,200,350], yPoints:[250,350,300], outlineColor:"red", color:"blue"},
            {name: "poly2", kind: "shape2D.PolyLine", xPoints:[300,500,650], yPoints:[250,350,300], outlineColor:"red", closePathFlag:false}
